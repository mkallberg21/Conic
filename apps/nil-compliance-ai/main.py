...
app = FastAPI(
    title="Conic NIL Compliance AI",
    description="AI-powered NIL disclosure analysis, FMV assessment, eligibility checks, and compliance reporting",
    version="1.0.0",
...
@app.get("/health")
def health():
    return {"status": "ok", "service": "nil-compliance-ai"}
